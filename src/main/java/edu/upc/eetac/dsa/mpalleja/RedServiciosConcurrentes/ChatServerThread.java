package edu.upc.eetac.dsa.mpalleja.RedServiciosConcurrentes;
...
public class ChatServerThread implements Runnable {
	private static List<ChatServerThread> threadList = Collections
			.synchronizedList(new ArrayList<ChatServerThread>());
